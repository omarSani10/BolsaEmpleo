...
<div class="hero d-flex justify-content-center align-items-center" style="background-image:url('<?php echo $imagenAleatoria; ?>'); height: 100vh; background-size: cover; background-position: center;">
				...
				<storn>	<span class="text-danger">Instituto Nelson Torres</span></storn>
				</h1>
					...
					<div class="center-container" style="display: flex; justify-content: center;">
							...
							<img src="images/qrMovil3.png" alt="qr" class="qr-image" style="width: 200px; height: auto; transition: transform 0.3s ease, opacity 0.3s ease;">
					</div>
